...
echo -e "Running command: nnUNet_find_best_configuration -m 2d -tr nnUNetTrainerV2 -t $1\n"
nvidia-smi
srun --unbuffered nnUNet_find_best_configuration -m 2d -tr nnUNetTrainerV2 -t $1
