...
echo -e "Running command: nnUNet_predict -i $NNUNET_PROJ_ROOT/$2 -o $NNUNET_PROJ_ROOT/nnUNet_predictions/$1/$3 -tr nnUNetTrainerV2 -ctr nnUNetTrainerV2CascadeFullRes -m 2d -p nnUNetPlansv2.1 -t $1\n"
nvidia-smi
# srun --unbuffered nnUNet_predict -f 0 -i $NNUNET_PROJ_ROOT/$2 -o $NNUNET_PROJ_ROOT/nnUNet_predictions/$1/$3 -t $1 -m 2d
srun --unbuffered nnUNet_predict -i $NNUNET_PROJ_ROOT/$2 -o $NNUNET_PROJ_ROOT/nnUNet_predictions/$1/$3 -tr nnUNetTrainerV2 -ctr nnUNetTrainerV2CascadeFullRes -m 2d -p nnUNetPlansv2.1 -t $1
